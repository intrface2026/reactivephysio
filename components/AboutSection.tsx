  ...
  return (
    <section className="relative w-full overflow-x-hidden">
      <motion.div
        ...
        className="relative flex w-full flex-col items-center pt-24 pb-[440px] sm:pt-32 sm:pb-[380px] md:min-h-[900px] md:pt-40 md:pb-56"
      >
        {/* Background Image */}
        ...
        <div className="relative z-10 flex w-full max-w-4xl flex-col items-center text-center px-5">
          ...
          <motion.h2
            ...
            className="max-w-3xl text-[24px] leading-[1.2] font-semibold tracking-tight text-white sm:text-[32px] md:text-[40px] lg:text-[46px]"
          >
        ...
        <motion.div
          ...
          className="absolute bottom-8 z-20 flex w-[92%] max-w-4xl flex-col overflow-hidden rounded-[24px] bg-white text-surface shadow-2xl border border-black/5 sm:bottom-10 md:bottom-12 md:flex-row md:items-stretch gap-0"
        >
          {/* Card Image Column */}
